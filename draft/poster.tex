...
\newcommand{\Face}{\red{Face}}
\newcommand{\Place}{\green{Place}}
\newcommand{\Object}{\blue{Object}}
...
%      		\item There has been great emphasis on identifying brain regions that seem to be reliably and specifically active even for quite complex cognitive functions, such as face (ref), place (ref), and object (ref) recognition. 
      		\item \textbf{However}, the focus on reliability, specificity, and locality of neural activity may reveal only a fraction of the full neural representation of these concepts and processes (ref).
      		\item We consider \Face, \Place, and \Object
      	\end{itemize}
      \end{block}
      \vskip2ex
      \begin{block}{}
